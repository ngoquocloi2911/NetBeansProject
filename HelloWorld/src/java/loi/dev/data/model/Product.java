...
public class Product {
    ...
    public Product(String name, String description, double price, int quality, int view, int categoryId, Timestamp createdAt) {
        this.name = name;
    ...
    public Product(int id, String name, String description, double price, int quality, int view, int categoryId, Timestamp createdAt) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.price = price;
